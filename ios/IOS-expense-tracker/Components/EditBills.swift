...
struct EditBillSheet: View {
    ...
    let originalBill: RecurringBill
    ...
    init(bill: RecurringBill, onSave: @escaping (RecurringBill) -> Void) {
        ...
        // Convert colorName back to Color for consistent comparison
        let initialColor: Color = {
            switch bill.colorName {
    ...
    private func saveBill() {
        ...
        let updatedBill = RecurringBill(
            ...
            category: category,
            nextDue: nextDue,
            isActive: originalBill.isActive,
            color: selectedColor
        )
        onSave(updatedBill)
        dismiss()
